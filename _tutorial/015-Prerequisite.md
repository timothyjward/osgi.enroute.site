...
In the enRoute tutorials file paths are always indicated using the forward slash or solidus ('/') as is customary on *nix like systems. The reason is that bnd, since iparemus-ran:_includes richardnicholson$ 
paremus-ran:_includes richardnicholson$ 
paremus-ran:_includes richardnicholson$ 
paremus-ran:_includes richardnicholson$ 
paremus-ran:_includes richardnicholson$ 
paremus-ran:_includes richardnicholson$ cat prerequisites.md 
Before you start any of the tutorials you must prepare your environment so that the right tools are installed. This page helps you to achieve this. We need to run the following tools on your computer:
